...
public class EmployeeController {
    ...
    public ResponseEntity<GeneralResponse> getVacationRequestsByEmployeeId(@PathVariable int id) {
        List<VacationResponse> vacations = vacationService.findAllByEmployeeId(id);
